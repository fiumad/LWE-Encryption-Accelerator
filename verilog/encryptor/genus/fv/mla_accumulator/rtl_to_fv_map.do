...
# Generated on: Sun Apr 13 17:12:19 EDT 2025 (Sun Apr 13 21:12:19 UTC 2025)
...
set logfile fv/mla_accumulator/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mla_accumulator -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../mla_acc.sv
elaborate_design -golden -root {mla_accumulator} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mla_accumulator/fv_map.v.gz
elaborate_design -revised -root {mla_accumulator}
...
set_analyze_option -mapping_file fv/mla_accumulator/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mla_accumulator.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mla_accumulator.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mla_accumulator.rtl.fv_map.rpt
