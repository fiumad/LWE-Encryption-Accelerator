...
# Generated by Genus(TM) Synthesis Solution 23.13-s073_1, revision 1.578
# Generated on: Sun Apr 13 17:17:54 EDT 2025 (Sun Apr 13 21:17:54 UTC 2025)
...
set logfile fv/crypto_prng/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/crypto_prng -revised fv_map -use_rtl_names
...
set env(RC_VERSION)     "23.13-s073_1"
set env(CDN_SYNTH_ROOT) "/cad/cds/DDI231/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/cds/DDI231/GENUS231/tools.lnx86"
set env(CW_DIR) "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/cad/cds/DDI231/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /cad/cds/GF_PDK/45SPCLO/45spclo_SC_BASE_9T_SG40RVT_2023q4v1/ -library -both
read_library -liberty -both \
    /cad/cds/GF_PDK/45SPCLO/45spclo_SC_BASE_9T_SG40RVT_2023q4v1/liberty/ccs_lib/45spclo_SC_BASE_9T_SG40RVT_TT_1P00V_85C_ccs.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../aes_sim.sv
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
add_search_path . -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../prng.sv
elaborate_design -golden -root {crypto_prng} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/crypto_prng/fv_map.v.gz
elaborate_design -revised -root {crypto_prng}
...
set_analyze_option -mapping_file fv/crypto_prng/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.crypto_prng.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.crypto_prng.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.crypto_prng.rtl.fv_map.rpt
