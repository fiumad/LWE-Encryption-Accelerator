...
# Generated on: Sun Apr 13 17:02:49 EDT 2025 (Sun Apr 13 21:02:49 UTC 2025)
...
set logfile fv/novel_mod_operator/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/novel_mod_operator -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../mod.sv
elaborate_design -golden -root {novel_mod_operator} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/novel_mod_operator/fv_map.v.gz
elaborate_design -revised -root {novel_mod_operator}
...
set_analyze_option -mapping_file fv/novel_mod_operator/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.novel_mod_operator.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.novel_mod_operator.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.novel_mod_operator.rtl.fv_map.rpt
